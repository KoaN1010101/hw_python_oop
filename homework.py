...
class Swimming(Training):
    """Тренировка: плавание."""
    LEN_STEP: float = 1.38
    CALORIES_CORRECTIVE_MULTIPLIER: float = 1.1
    WEIGHT_CALORIES_CORRECTIVE_MULTIPLIER: int = 2
    ...
    def get_spent_calories(self) -> float:
        return ((self.get_mean_speed() + self.CALORIES_CORRECTIVE_MULTIPLIER)
                * self.WEIGHT_CALORIES_CORRECTIVE_MULTIPLIER
